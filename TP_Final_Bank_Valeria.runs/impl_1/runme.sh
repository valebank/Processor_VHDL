...
HD_PWD='C:/UTN/3er/TD1/TP/TP_Final_Bank_Valeria/TP_Final_Bank_Valeria.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microIO.tcl -notrace
