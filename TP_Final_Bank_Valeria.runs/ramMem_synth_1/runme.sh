...
HD_PWD='C:/UTN/3er/TD1/TP/TP_Final_Bank_Valeria/TP_Final_Bank_Valeria.runs/ramMem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ramMem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ramMem.tcl
